    ...
    <div className="viewParentDiv">
      ...
      <div className="rightSection">
        <div className="productDetails">
          <p>
            <span style={{ fontSize: "20px" }}>Requested Amount:</span> &#x20B9;{" "}
            {postContent.fund} Lakh
          </p>
          <span>Company Name: {postContent.cname}</span>
          <p>Founder Name: {postContent.name}</p>
          <p>LinkedIn: {postContent.linkedin}</p>
          <span>Gross Margin: {postContent.gMargin}</span>
          <p>Net Margin: {postContent.nMargin}</p>
          <p>Equity: {postContent.equity}%</p>
        ...
        {userDetails && (
          <div className="contactDetails">
            <p className="p-bold">Founder details</p>
